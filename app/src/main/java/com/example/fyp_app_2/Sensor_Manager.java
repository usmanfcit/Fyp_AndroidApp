...
import com.example.fyp_app_2.SendDataToServer;

import java.util.List;
/// A class to manage all the aspects of dealing withSensors
public class Sensor_Manager  implements SensorEventListener{
    private SensorManager sensorManager;
    private List<Sensor> sensorList;

    private SendDataToServer sendData;

    private TextView textView;
    public void getAvailableSensorList(){
...
//        return sensorList;
    ...
    // Constructor
    public Sensor_Manager(Context context, TextView textView) {
...
//            textView.setText(textView.getText()+"\n"+sensorData.toString());
            sendData.doInBackground(sensorData.toString());
